...
There is an SWD header on the board.  This header goes to the programmer which can erase the chip, and flash the hex bootloader.

nrfjprog -f nrf52 --eraseall

nrfjprog --program feather_nrf52840_express_bootloader-0.2.13_s140_6.1.1.hex --chiperase -f nrf52 --reset
...
Next you simply pull the latest circuitpython firmware, UF2 file, over into the FTHR840BOOT folder. As of 1/16/2020 the uf2 file looks like this:
adafruit-circuitpython-feather_nrf52840_express-en_US-4.1.2.uf2
